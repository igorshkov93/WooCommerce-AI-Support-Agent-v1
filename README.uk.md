...
| **negative_high** | Термінове: повернення коштів, пошкодження, гнів | Картка в Trello · Slack `#allerts` з `@channel` |
| **spam** | Реклама, беззмістовний текст | Лог у Slack `#all-test_workspace` |
| **fallback** | Будь-що поза чотирма класами | Лог у Slack `#all-test_workspace` |
